...
export default function App() {
  ...
  const { theme, isDark, setTheme: setAppTheme } = useTheme()
      ...
      <header className="flex-none border-b border-border-subtle px-4 py-2.5 bg-surface-elevated">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-semibold text-text-primary tracking-tight">DeckNinja <span className="text-[9px] font-normal text-text-muted">v1.3.0</span></h1>
            </div>
          </div>
          <div className="flex items-center gap-0.5">
            ...
            <button
              ...
              className="relative p-1.5 rounded-md text-text-secondary hover:bg-surface-hover transition-colors"
              title={t(theme === 'system' ? 'theme.system' : theme === 'dark' ? 'theme.dark' : 'theme.light')}
            >
              {isDark ? (
