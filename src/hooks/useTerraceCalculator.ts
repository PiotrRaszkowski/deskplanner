...
export function useTerraceCalculator() {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      ...
      const upperResult = calculateJoistLayout(polygon, upperJoists, angle, 'upper', joistOffcutSettings)
      const lowerResult = calculateJoistLayout(polygon, lowerJoists, angle, 'lower', joistOffcutSettings)
